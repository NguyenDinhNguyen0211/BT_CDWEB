package btgk.ltw.springboot.service;
...
public class ForumService {
    ...
    private void init() {
        ...
        Topic topic2 = new Topic(2, "Thủ tướng: Trường ĐH tự quyết mức học phí",
                "ọc phí mầm non và phổ thông ở trường công lập là sự đóng góp một phần nhỏ "
    ...
    public List<Topic> getTopics() {
        List<Topic> topicList = topics.values().stream().toList();
        return topicList;
    }
    ...
    public Topic add(Topic topic) {
        return topics.put(topic.getId(), topic);
    }
